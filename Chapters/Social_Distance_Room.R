pack.circles <- function(config, size=c(100, 100), max.iter=1000, overlap=0 ) {
  ...
  print(head(xyr))
  #Identify Chair Center Points
  chair_pos = as.data.frame(xyr)
  colnames(chair_pos) = c("X","Y","Distance")
  chair_pos = round(chair_pos)
  #print(head(chair_pos))
  ...
  xyr[, 3] <- xyr[, 3] / PRADIUS
  for (i in 1:nrow(xyr)) {
    draw.circle(xyr[i, 1], xyr[i, 2], xyr[i, 3], col=randomColor(1))
  }
  return (chair_pos)
  # ------------------------------------------
  # return the layout
...
#Initial Input Data
tdata= matrix(c(6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,
                1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,
                1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,
                1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,1,6,
                1,6,1,6,1,6,1,6,1,6,1,6,1,6,1),byrow=TRUE, nrow=80)
nrow(tdata)
#Add a person to the room
add_data = matrix(c(6,1),byrow=TRUE, nrow=1)
rbind( tdata,add_data)

#Output Final People Coordinates
output = pack.circles(tdata,size=c(100,100))
